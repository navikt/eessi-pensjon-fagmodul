...
class PrefillPDLNavTest {
    ...
    companion object {
        ...
        fun lagNavPerson(foreldersPin: String, fornavn: String, etternavn: String, fdato: String, someInstitutionId: String? = null, someIntitutionNavn: String? = null, kjoenn: String? = "M") =
            Person(
                pin = listOf(PinItem(

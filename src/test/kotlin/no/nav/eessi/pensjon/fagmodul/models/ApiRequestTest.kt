...
class ApiRequestTest {
    ...
    fun `check on minimum valid request to model`() {
        ...
        val model = ApiRequest.buildPrefillDataModelOnExisting(mockData, PersonInfo("12345", "0105094340092"), null)
    ...
    fun `check on minimum valid request to model on P2100`() {
        ...
        val model = ApiRequest.buildPrefillDataModelOnExisting(mockData, PersonInfo("12345", "0105094340092"), "2223312")
    ...
    fun `check valid request to model on P_BUC_02 P5000`() {
        ...
        val model = ApiRequest.buildPrefillDataModelOnExisting(mockData, PersonInfo("23123", "0105094340092"), "113123123123")

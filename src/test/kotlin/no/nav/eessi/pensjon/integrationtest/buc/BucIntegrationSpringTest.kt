...
class BucIntegrationSpringTest {
    ...
    fun `Gitt det ikke finnes noen SED i en buc med avdød så skal det vies et tomt resultat`() {
        ...
        //doReturn( ResponseEntity.ok().body(emptyList<Rinasak>().toJson()) ).whenever(restEuxTemplate).exchange( eq(rinaBuc02url.toUriString()), eq(HttpMethod.GET), null, eq(String::class.java))
        ...
        //doReturn( ResponseEntity.ok().body(rinaSakerBuc05.toJson())  ).whenever(restEuxTemplate).exchange( eq(rinaBuc05url.toUriString()), eq(HttpMethod.GET), null, eq(String::class.java))
        ...
        //doReturn( ResponseEntity.ok().body( emptyList<Rinasak>().toJson())  ).whenever(restEuxTemplate).exchange( rinaBuc10url.toUriString(), HttpMethod.GET, null, String::class.java)
        ...
        //doReturn( ResponseEntity.ok().body( buc05 ) ).whenever(restEuxTemplate).exchange( eq(rinabucpath), eq(HttpMethod.GET), null, eq(String::class.java))
    ...
    fun `Gitt det finnes gjenlevende og en avdød på buc02 så skal det hentes og lever en liste av buc`() {
        ...
        //buc10 avdød rinasak
        val rinaBuc10url = dummyRinasakAvdodUrl(avdodFnr, "P_BUC_10")
        //doReturn( ResponseEntity.ok().body( emptyList<Rinasak>().toJson())  ).whenever(restEuxTemplate).exchange( eq(rinaBuc10url.toUriString()), eq(HttpMethod.GET), null, eq(String::class.java))
        every { restEuxTemplate.exchange(rinaBuc10url.toUriString(), HttpMethod.GET, null, String::class.java) } returns ResponseEntity.ok().body( emptyList<Rinasak>().toJson())
    ...
    fun `Gitt det finnes en gjenlevende og avdød hvor buc05 buc06 og buc10 finnes Så skal det returneres en liste av buc`() {
        ...
        every { restEuxTemplate.exchange( eq(rinabuc06documentidpath), eq(HttpMethod.GET), null, eq(String::class.java)) } returns
                ResponseEntity.ok().body( SED(SedType.P7000, pensjon = Pensjon(gjenlevende = Bruker(person = Person(pin =
                listOf( PinItem(land = "NO", identifikator = gjenlevendeFnr)), fornavn = "test", etternavn = "etter")))).toJsonSkipEmpty())

        //buc10 sed
        val rinabucd10ocumentidpath = "/buc/4040/sed/10"
        every { restEuxTemplate.exchange( eq(rinabucd10ocumentidpath), eq(HttpMethod.GET), null, eq(String::class.java)) } returns
                ResponseEntity.ok().body( SED(SedType.P15000, pensjon = Pensjon(gjenlevende = Bruker(person = Person(pin = listOf(PinItem(land = "NO", identifikator = gjenlevendeFnr)), fornavn = "test", etternavn = "etter")))).toJsonSkipEmpty() )
        ...
        verify (exactly = 1) { restEuxTemplate.exchange("/rinasaker?fødselsnummer=1234567890000&rinasaksnummer=&buctype=&status=", HttpMethod.GET, null, String::class.java) }
        verify (exactly = 1) { restSafTemplate.exchange("/buc/2020", HttpMethod.GET, httpEntity, String::class.java) }
        verify (exactly = 1) { restSafTemplate.exchange("/buc/2020/sed/5", HttpMethod.GET, httpEntity, String::class.java) }
        verify (exactly = 1) { restSafTemplate.exchange("/buc/3030", HttpMethod.GET, httpEntity, String::class.java) }
        verify (exactly = 1) { restSafTemplate.exchange("/buc/3030/sed/6", HttpMethod.GET, httpEntity, String::class.java) }
        verify (exactly = 1) { restSafTemplate.exchange("/buc/4040", HttpMethod.GET, httpEntity, String::class.java) }
        verify (exactly = 1) { restSafTemplate.exchange("/buc/4040/sed/10", HttpMethod.GET, httpEntity, String::class.java) }
        verify (exactly = 1) { restSafTemplate.exchange(eq("/") , HttpMethod.POST, httpEntity, String::class.java) }
   }

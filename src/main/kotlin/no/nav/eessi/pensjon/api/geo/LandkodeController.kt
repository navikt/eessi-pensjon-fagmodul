...
class LandkodeController(private val kodeverkClient: KodeverkClient) {
    ...
    @Operation(description = "Henter liste over land, land2 og land3 av ISO Alpha2 og ISO Alpha3 standard")
    @GetMapping("/")
    fun getLandKoder(): String {
        return kodeverkClient.hentAlleLandkoder()
    }

    @Operation(description= "Henter liste over landkoder av ISO Alpha2 standard")
    ...
    @Operation(description = "Henter ut land ISO Alpha3 standard hvor nøkkel er ISO Alpha2")
    ...
    @Operation(method = "getLandKoderAlpha2",  description ="Henter ut land ISO Alpha2 standard hvor nøkkel er ISO Alpha3")

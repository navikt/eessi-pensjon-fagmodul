...
object EessiFellesDto { // brukes kun for namespace.
    ...
    enum class EessiSakStatus { TIL_BEHANDLING, INGEN_STATUS, OPPRETTET, UKJENT, TRUKKET, AVBRUTT, AVSL, INNV, OPPHOR, VELG, VETIKKE, ANNET, EESSI_INGEN_STATUS, EESSI_UKJENT, EESSI_AVBRUTT, AVSLUTTET}
    enum class EessiKravAarsak { GJNL_SKAL_VURD, TILST_DOD, NY_SOKNAD, ANNET, ENDRET_OPPTJENING, ANNEN_ARSAK, OPPL_UTLAND, OMREGNING }
